...
const botStatus = (bot: Bot, systemStatus: SystemStatus, lng?: string) => {
    ...
    const embed_ = new EmbedBuilder()
        ...
        .setDescription(
            bot.i18n.t('embeds:STATUS_DESCRIPTION', {
                serverCount: systemStatus.serverCount,
                playingCount: systemStatus.playing,
                lng,
            }),
        )
        .addFields(
            {
                name: bot.i18n.t('embeds:STATUS_SYSTEM_TITLE', { lng }),
                value: bot.i18n.t('embeds:STATUS_SYSTEM_VALUE', {
                    os_version: bot.sysInfo.os_version,
                    node_version: bot.sysInfo.node_version,
                    dc_version: bot.sysInfo.dc_version,
                    shark_version: bot.sysInfo.shark_version,
                    cpu: bot.sysInfo.cpu,
            ...
            {
                name: bot.i18n.t('embeds:STATUS_USAGE_TITLE', { lng }),
                value: bot.i18n.t('embeds:STATUS_USAGE_VALUE', {
                    cpuUsage: cpuUsage,
                    ramUsage: ramUsage,
                    heapUsage: heapUsage,
                    lng,
            ...
            {
                name: bot.i18n.t('embeds:STATUS_LATENCY_TITLE', { lng }),
                value: bot.i18n.t('embeds:STATUS_LATENCY_VALUE', {
                    botPing: systemStatus.ping.bot,
                    apiPing: systemStatus.ping.api,
                    lng,
                }),
                inline: false,
            },
...
const nodesStatus = (bot: Bot, unhealthValue: number, nodesStatus: { name: string; value: string }[], lng?: string) => {
    const healthString =
        unhealthValue > 0
            ? bot.i18n.t('embeds:NODE_UNHEALTHY', { unhealthValue: unhealthValue, lng })
            : bot.i18n.t('embeds:NODE_ALL_ACTIVE', { lng });
...
const nodeStatus = (
    ...
    const embed_ = new EmbedBuilder()
        ...
        .addFields(
            {
                name: bot.i18n.t('embeds:NODE_STATUS_INFO_TITLE', { lng }),
                value: bot.i18n.t('embeds:NODE_STATUS_INFO_VALUE', {
                    version: nodeInfo.version.semver,
                    jvm: nodeInfo.jvm,
                    lavaplayer: nodeInfo.lavaplayer,
                    git: nodeInfo.git.commit,
                    buildTime: timestampToTime(nodeInfo.buildTime),
                    lng,
                }),
            },
            {
                name: bot.i18n.t('embeds:NODE_STATUS_STATS_TITLE', { lng }),
                value: bot.i18n.t('embeds:NODE_STATUS_STATS_VALUE', {
                    uptime: msToTime(nodeStats.uptime),
                    pingKey: bot.i18n.t('embeds:NODE_STATUS_PING', { lng }),
                    nodePing: nodePing,
                    playerCount: nodeStats.players,
                    playingCount: nodeStats.playingPlayers,
                    lng,
                }),
            },
            {
                name: bot.i18n.t('embeds:NODE_STATUS_CPU_TITLE', { lng }),
                value: bot.i18n.t('embeds:NODE_STATUS_CPU_VALUE', {
                    cores: nodeStats.cpu.cores,
                    systemLoad: nodeStats.cpu.systemLoad.toFixed(6),
                    lavalinkLoad: nodeStats.cpu.lavalinkLoad.toFixed(6),
                    lng,
                }),
            },
            {
                name: bot.i18n.t('embeds:NODE_STATUS_MEMORY_TITLE', { lng }),
                value: bot.i18n.t('embeds:NODE_STATUS_MEMORY_VALUE', {
                    used: formatBytes(nodeStats.memory.used),
